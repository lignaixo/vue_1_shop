  ...
  <main id="main" class="container">
        ...
        <div class="row mb-2">
          <div id="p1" class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block" :src="p1.pic" />
            </div>
          </div>
          <div id="p2" class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" :src="p2.pic" />
            </div>
          </div>
        </div>
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" :src="p3.pic" />
            </div>
          </div>
          ...
          <div class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <h6 class="mb-5">
                  <a class="text-dark" href="javascript:;">酷睿双核i5处理器|256GB
              ...
              <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb"
                alt="Thumbnail [200x250]" src="/img/index/study_computer_img1.png" data-holder-rendered="true" />
            </div>
          </div>
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb"
                alt="Thumbnail [200x250]" src="/img/index/study_computer_img2.png" data-holder-rendered="true" />
            </div>
          </div>
        </div>
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb"
                alt="Thumbnail [200x250]" src="/img/index/study_computer_img3.png" data-holder-rendered="true" />
            </div>
          </div>
          <div class="col-md-7">
            <div class="row pr-3">
    ...
    <div class="btn-group-vertical position-fixed" role="group" aria-label="Basic example">
      <button type="button" class="
          ...
          border-light border-left-0 border-right-0
        ">
        首页<br />推荐
      </button>
      <button type="button" class="
